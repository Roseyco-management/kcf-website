    ...
    <html lang="en" className={`${playfair.variable} ${dmSans.variable}`}>
      <body className="antialiased">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          ...
          fbq('init', '1520686439196434'); // KCF pixel
          fbq('init', '26883368071312352'); // Ernesto's pixel
          fbq('track', 'PageView');
        `}} />
        <noscript>
          {/* KCF pixel */}
          ...
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=26883368071312352&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
