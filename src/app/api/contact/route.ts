...
export async function POST(request: Request) {
  try {
    ...
    // details or message (GDPR data-minimisation). Best-effort; never blocks
    // the admin alert above.
    try {
      await resend.emails.send({
        ...
        text: [
          ...
          "Source: Contact form",
          "",
          "Contact details & message withheld — full lead sent to the client.",
        ].join("\n"),
      });
    } catch (agencyError) {
            ...
            <div class="container">
              ...
              <div class="content">
                ...
                <div class="contact-box">
                  ...
                  <p style="margin: 10px 0;">Phone: <a href="tel:+18166056595" style="color: #C9A961;">(816) 605-6595</a></p>
