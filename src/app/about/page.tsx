...
const teamMembers = [
  {
    ...
    bio: "With over 15 years of experience in Kansas City real estate, Ernesto founded KC Family Home Team with a vision to provide families with the personalized service they deserve.",
  ...
  },
  {
    ...
    bio: "Monica ensures every client receives exceptional service from start to finish. Her attention to detail and communication skills keep every transaction running smoothly.",
    phone: "+1 (816) 575-7763",
  ...
  },
  {
    ...
    bio: "Chris specializes in managing transactions and properties with precision. His organizational skills and attention to detail keep every deal running smoothly.",
    phone: "+1 (816) 575-7763",
