...
export const metadata: Metadata = {
  ...
  description: "Meet Ernesto, Monica, Chris, and Sandy - your dedicated Kansas City real estate team. 15+ years experience helping families buy and sell homes. Expert local agents ready to help you.",
  keywords: [
...
const teamMembers = [
  {
    ...
    bio: "Licensed in Kansas and Missouri since 2010, Ernesto brings over 15 years of real estate expertise to every transaction. He started his career as a wholesaler and property manager before becoming a full-time agent in 2014. Since then, he has represented hundreds of buyers and sellers with great attention to detail and strong negotiation skills to look out for their best interests. From first-time buyers to families purchasing their second or forever home, Ernesto provides personalized, stress-free home buying experiences tailored to each family's unique needs. His approach emphasizes transparency, clear communication, and a genuine understanding of your goals, backed by a service satisfaction promise.",
    specialties: ["Buyer & Seller Representation", "Listing Strategy", "Negotiation", "Market Analysis", "Team Leadership"],
    stats: [
  ...
  },
  {
    ...
    specialties: ["Buyer & Seller Representation", "Listing Specialist", "First-Time Buyers", "Down Payment Assistance", "Investment Properties", "Client Communication"],
    stats: [
  ...
  },
  {
    ...
    specialties: ["Buyer & Seller Representation", "Client Relations", "Market Knowledge", "Family Homes", "Customer Service"],
    stats: [
      { label: "Client Rating", value: "5.0" },
    ],
  },
